...
export const TABLE_PROMPT = `You are working with javascript program, I will give you a \`table: {column: string[], rows: Row[]}\`, where Rows is {[column key]: string}, notice the row value type is string.
